...
راجع هذه البيانات وأرجع JSON بالشكل التالي:
{
  ...
  "interpretation": "تفسير شامل ومفصل للنتائج في 4-6 فقرات يوضح: هل المشروع يستحق؟ لماذا؟ ما المميزات والعيوب؟ ما الخطوة التالية الموصى بها؟ نصائح عملية لهذا الموقع تحديداً. اكتب بأسلوب احترافي ودافئ كأنك تتحدث مباشرة للعميل."
}
